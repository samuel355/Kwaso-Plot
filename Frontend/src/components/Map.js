...
const Map = () => {
  return (
    <div  iv class="fancy-contact-area section-padding-100">
        <div class="container">
            <div class="row mb-2">
                <div class="col-12" style={{display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
                ...
                <div class="col-12">
                    <div class="contact-form-area">
                        <div class="section-heading ">
                            <h2 class="text-center">Reach out to Us if you want to Buy or Reserve a land</h2>
                            <p class="text-center" style={{fontSize: 'large', fontWeight: '400'}} id="filll">Choose an
                            ...
                            <form action="#" method="post" id="message-form">
                                ...
                                <div class="contact_input_area">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <textarea readonly name="message" class="form-control" id="message"
                                                    cols="35" rows="15"
                                        ...
                                        <div class="col-12 text-center">
                                            <button type="submit" id="submit"
                                                class="btn fancy-btn fancy-dark bg-transparent">Send</button>
                                        </div> <br />
                                    </div>
                                </div>
                            </form>
